...
export const en = {
  ...
  calculator: {
    ...
    back_btn: "Back",
    next_btn: "Next",
    mode_simple: "Simple (Equal for all)",
    mode_advanced: "Flexible (Time Periods)",
    add_period_title: "Add New Period",
    add_period_btn: "Add Period",
    no_periods: "No periods added yet.",
    cap_05: "0.5 Sets / Day (Light - 3 Prayers)",
    cap_1_dropdown: "1 Set / Day (Standard - 6 Prayers)",
    cap_2_dropdown: "2 Sets / Day (Ambitious)",
    cap_3_dropdown: "3 Sets / Day (Intense)",
    cap_4_dropdown: "4 Sets / Day",
    cap_5_dropdown: "5 Sets / Day (Maximum)",
    set_expl_title: "What does '1 Set' mean?",
    set_expl_text: "A 'Set' corresponds to a full prayer day (Fajr, Dhuhr, Asr, Maghrib, Isha, Witr).",
    set_expl_05: "0.5 Sets: You make up 3 prayers every day.",
    set_expl_1: "1 Set: You make up a complete day every day.",
    reset_title: "Reset previous progress?",
    reset_desc_active: "If activated, ALL previously tracked prayers will be deleted and you start at 0 completed prayers.",
    reset_desc_inactive: "If deactivated, only your open target (debt) will be adjusted, your progress remains.",
    finish_btn: "Save Plan",
    female_label: "Account for Menstruation",
